...
README.md:69:| **CP4**<br>concepção | Documentação (43 RF, 22 RNF, 25 regras), 12 diagramas UML, identidad...
README.md:70:| **CP5**<br>protótipo | 12 rotas navegáveis com dados mockados: login, onboarding, inscrição...
README.md:71:| **CP6**<br>entrega final | API NestJS sobre PostgreSQL, 43 operações, capacidade garantida ...
...
|---|---|---|
| ⚠️ **Religar o GitHub Pages no modo `GitHub Actions`** | É configuração do repositório. Hoje a origem é `legacy`, e a cada push o Jekyll (que renderiza o `README.md`) corre com o artefato do app — quem publica por último fica no ar. Em 2026-09-11 as duas coisas aconteceram com 8 min de diferença: às 15:25 o site serviu o README e cinco caminhos deram 404; às 15:33 voltou ao normal. **Confira o link antes de entregar.** `Settings → Pages → Source: GitHub Actions`, ou `gh api -X PUT repos/lukiin-z/campus/pages -f build_type=workflow` | [`README.md`](../../README.md#ver-funcionando-agora) |
